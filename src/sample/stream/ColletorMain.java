...
/**
 * @author wangxl@ushareit.com  2020/12/28 18:39
 */
public class ColletorMain {
    public static void main(String[] args) {
        ...
        System.out.println("groupingBy:"+ageMap.toString());
        ...
        /**
         * 下面的toMap用到了该方法的比较高级的API---------如果map中的key存在重复的，则保留key
         */
